					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "trainer ui5 app",
									"targetURL": "#ui5app-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5app-display": {
								"semanticObject": "ui5app",
								"action": "display",
								"description": "Trainer App",
								"title": "trainer ui5 app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5app",
									"url": sap.ui.require.toUrl("ui5app")
								}
							}
						}
					}
